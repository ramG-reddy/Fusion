...
urlpatterns = [
    ...
    url(
        r"^handleEngineerProcessRequests/",
        views.handleEngineerProcessRequests,
        name="Engineer-Process-Requests",
    ),
    url(
        r"^engineerProcessedRequestsView/",
        views.engineerProcessedRequests,
        name="Engineer-Processed-Requests view",
    ),
    url(
        r"^handleDeanProcessRequests/",
        views.handleDeanProcessRequests,
        name="Dean-Process-Requests",
    ),
    url(
        r"^deanProcessedRequestsView/",
        views.deanProcessedRequests,
        name="Dean-Processed-Requests view",
    ),
    url(
        r"^handleDirectorApprovalRequests/",
        views.handleDirectorApprovalRequests,
        name="Director-Approval-Requests",
    ),
    url(
        r"^updateRejectedRequests/",
        views.updateRejectedRequests,
        name="Update-Rejected-Requests",
    ),
    url(
        r"^handleUpdateRequests/",
        views.handleUpdateRequests,
        name="Handle-Update-Requests",
    ),
    # url('rejectedRequests/', views.rejectedRequests, name='Rejected-Requests'),
    url(
        r"^rejectedRequestsView/", views.rejectedRequests, name="Rejected Requests view"
    ),
    ...
    url(
        r"^handleBillGeneratedRequests/",
        views.handleBillGeneratedRequests,
        name="Handle-Bill-Generated-Requests",
    ),
    url(r"^generatedBillsView/", views.generatedBillsView, name="Generated-Bills-View"),
    url(
        r"^handleProcessedBills/",
        views.handleProcessedBills,
        name="Handle-Processed-Bills",
    ),
    ...
    url(
        r"^handleSettleBillRequests/",
        views.handleSettleBillRequests,
        name="Handle-Settle-Bill-Requests",
    ),
