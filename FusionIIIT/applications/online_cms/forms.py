...
class GradingSchemeForm(forms.Form):
    ...
    midsem_weightage = forms.DecimalField(
        label="Mid Semester", max_digits=10, decimal_places=2
    )
    assignment_weightage = forms.DecimalField(
        label="Assignment", max_digits=10, decimal_places=2
    )
    endsem_weightage = forms.DecimalField(
        label="End Semester", max_digits=10, decimal_places=2
    )
    project_weightage = forms.DecimalField(
        label="Project", max_digits=10, decimal_places=2
    )
