...
class AttendanceFiles(models.Model):
    ...
    def __str__(self):
        return f"{self.course_id} - {self.file_name}"
...
class CourseVideo(models.Model):
    ...
    def __str__(self):
        return f"{self.course_id} - {self.video_name}"
...
class Topics(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.course_id} - {self.topic_name}"
...
class QuestionBank(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.instructor_id} - {self.name}"
...
class Quiz(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.course_id} - {self.start_time} - {self.end_time} - {self.negative_marks}"
...
class PracticeQuestion(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.quiz_id} - {self.options1} - {self.options2} - {self.options3} - {self.options4} - {self.options5} - {self.answer} - {self.announcement}"
...
class StudentAnswer(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.student_id} - {self.quiz_id} - {self.question_id} - {self.choice}"
...
class Assignment(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.course_id} - {self.assignment_name}"
...
class StudentAssignment(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.student_id} - {self.assignment_id} - {self.score} - {self.feedback}"
...
class QuizResult(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.student_id} - {self.quiz_id} - {self.score} - {self.finished}"
...
class Forum(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.course_id} - {self.commenter_id} - {self.comment}"
...
class ForumReply(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.forum_ques} - {self.forum_reply}"
...
class StudentEvaluation(models.Model):
    ...
    def __str__(self):
        return f"{self.pk} - {self.student_id} - {self.evaluation_id} - {self.marks}"
