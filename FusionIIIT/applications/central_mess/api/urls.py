...
urlpatterns = [
    ...
    url(
        "menuChangeRequestApi",
        views.Menu_change_requestApi.as_view(),
        name="menuChangeRequestApi",
    ),
    ...
    url(
        "specialRequestApi",
        views.Special_requestApi.as_view(),
        name="specialRequestApi",
    ),
    ...
    url(
        "get_mess_students",
        views.Get_Filtered_Students.as_view(),
        name="get_mess_students",
    ),
    ...
    url(
        "get_student_payment",
        views.Get_Student_Payments.as_view(),
        name="student_payment_API",
    ),
    url(
        "get_student_all_details",
        views.Get_Student_Details.as_view(),
        name="get_student_details_API",
    ),
    url(
        "registrationRequestApi",
        views.RegistrationRequestApi.as_view(),
        name="registrationRequestApi",
    ),
    url(
        "deRegistrationRequestApi",
        views.DeregistrationRequestApi.as_view(),
        name="deRegistrationRequestApi",
    ),
    url(
        "deRegistrationApi", views.DeregistrationApi.as_view(), name="deRegistrationApi"
    ),
    url(
        "updatePaymentRequestApi",
        views.UpdatePaymentRequestApi.as_view(),
        name="updatePaymentRequestApi",
    ),
]
