...
class Mess_regApi(APIView):
    ...
    def post(self, request):
        ...
        obj = Mess_reg(sem=sem, start_reg=start_reg, end_reg=end_reg)
        obj.save()
        return Response({"status": 200})
...
class Monthly_billApi(APIView):
    ...
    def post(self, request):
        ...
        try:
            reg_main = Monthly_bill.objects.get(
...
class RebateApi(APIView):
    ...
    def put(self, request):
        ...
        rebate_request = get_object_or_404(
            Rebate,
            student_id=student_id,
            end_date=end_date,
            start_date=start_date,
...
class Vacation_foodApi(APIView):
    ...
    def put(self, request):
        ...
        try:
            vacation_food_request = get_object_or_404(
                Vacation_food,
                student_id=student_id,
                app_date=app_date,
                purpose=purpose,
            ...
            vacation_food_request = Vacation_food.objects.filter(
                student_id=student_id,
                app_date=app_date,
                purpose=purpose,
                end_date=end_date,
...
class Special_requestApi(APIView):
    ...
    def put(self, request):
        ...
        special_request = get_object_or_404(
            Special_request,
            student_id=student_id,
            app_date=app_date,
            item1=item1,
...
class Menu_change_requestApi(APIView):
    def get(self, request):
        ...
        serialized_obj = Menu_change_requestSerializer(
            menu_change_request_obj, many=True
        )
        return Response({"status": 200, "payload": serialized_obj.data})
...
class Get_Student_Details(APIView):
    def post(self, request):
        ...
        serialized_obj = GetFilteredSerialzer(reg_main)
        data = {
            "payment": payment_serialized_obj.data,
            "bill": bill_serialized_obj.data,
            "reg_records": reg_record_serialized_obj.data,
            "student_details": serialized_obj.data,
        }
        ...
        try:
            ...
            if new_status == "accept":
                ...
                new_reg_record = Reg_records(
                    student_id=student, start_date=start_date, end_date=None
                )
                new_reg_record.save()
...
class DeregistrationRequestApi(APIView):
    ...
    def put(self, request):
        try:
            ...
            deregistration_request = get_object_or_404(
                Deregistration_Request, student_id=student_id, end_date=end_date
            )
            ...
            if new_status == "accept":
                ...
                reg_record = Reg_records.objects.filter(student_id=student).latest(
                    "start_date"
                )
...
class UpdatePaymentRequestApi(APIView):
    ...
    def put(self, request):
        try:
            ...
            UpdatePayment_request = get_object_or_404(
                Update_Payment,
                student_id=student_id,
                payment_date=payment_date,
                amount=amount,
