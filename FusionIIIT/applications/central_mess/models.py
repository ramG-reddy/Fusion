...
MEAL_TIME = (("breakfast", "Breakfast"), ("lunch", "Lunch"), ("dinner", "Dinner"))
...
MESS_OPTION = (("mess1", "Mess1"), ("mess2", "Mess2"))
...
class Messinfo(models.Model):
    ...
    def __str__(self):
        return f"{self.student_id.id} - {self.mess_option}"
...
class Monthly_bill(models.Model):
    ...
    def __str__(self):
        return f"{self.student_id.id} - {self.month} - {self.year}"
...
class Menu(models.Model):
    ...
    def __str__(self):
        return f"{self.mess_option} - {self.meal_time} - {self.dish}"
...
class Mess_meeting(models.Model):
    ...
    def __str__(self):
        return f"{self.meet_date} - {self.agenda}"
...
class Mess_minutes(models.Model):
    ...
    def __str__(self):
        return f"{self.meeting_date.meet_date} - {self.mess_minutes}"
...
class Menu_change_request(models.Model):
    ...
    def __str__(self):
        return f"{self.id} - {self.dish} - {self.request} - {self.status}"
