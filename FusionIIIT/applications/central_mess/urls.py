...
urlpatterns = [
    ...
    url(
        r"^closemessregistration/",
        views.closeRegistration,
        name="closemessregistration",
    ),
    ...
    url(
        r"^registeredstudent", views.searchAddOrRemoveStudent, name="registeredstudent"
    ),
    ...
    url(
        r"^respond_to_updatePayment",
        views.respond_to_update_payment,
        name="response_to_update_payment",
    ),
