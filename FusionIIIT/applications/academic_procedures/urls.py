...
urlpatterns = [
    ...
    url(
        r"^auto_pre_registration/",
        views.auto_pre_registration,
        name="automatic_pre_register",
    ),
    ...
    url(
        r"^auto_process_verification_request/$", views.auto_process_verification_request
    ),
    ...
    url(
        r"^acad_person/get_next_sem_courses/",
        views.get_next_sem_courses,
        name="get_next_sem_courses",
    ),
    url(
        r"^acad_person/remove_course_from_slot/",
        views.remove_course_from_slot,
        name="remove_course_from_slot",
    ),
    url(
        r"^acad_person/add_course_to_slot/",
        views.add_course_to_slot,
        name="add_course_to_slot",
    ),
    ...
    url(
        r"^register_backlog_course/",
        views.register_backlog_course,
        name="register_backlog_course",
    ),
]
