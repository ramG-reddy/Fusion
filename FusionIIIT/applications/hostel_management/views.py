...
from .forms import GuestRoomBookingForm, HallForm, HostelNoticeBoardForm
from .models import *
from .models import HallCaretaker, HallWarden, HostelLeave, StudentDetails
from .utils import (
    add_to_room,
    get_caretaker_hall,
    remove_from_room,
...
def hostel_notice_board(request):
    notices = all().values(
        "id", "hall", "posted_by", "head_line", "content", "description"
    )
    data = list(notices)
...
class AssignCaretakerView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            self.template_name,
            {"halls": hall, "caretaker_usernames": caretaker_usernames},
        )
