...
urlpatterns = [
    ...
    url(
        r"^forwardedIndent/(?P<id>\d+)/$", views.forwardedIndent, name="forwardedIndent"
    ),
    ...
    url(
        r"^stock_entry_item_view/$",
        views.stock_entry_item_view,
        name="stock_entry_item_view",
    ),
    ...
    url(
        r"^update_stock_item_inUse/$", views.updateStockItemInUse, name="stockItemInUse"
    ),
