        ...
        if "Submit" in request.POST:
            ...
            if batch == "all":
                ...
                query = reduce(
                    or_,
                    (
                        Q(id__id__startswith=int(batch) - 2000)
                ...
                recipient = Student.objects.filter(
                    programme=programme, id__id__startswith=int(batch) - 2000
                )
            ...
            zest = Previous_winner.objects.filter(
    ...
    for dates in release:
        if checkDate(dates.startdate, dates.enddate):
            ...
            if (
                ...
                and dates.batch == "20" + str(request.user.extrainfo.student)[0:2]
