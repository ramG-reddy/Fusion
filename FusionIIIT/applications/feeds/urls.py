...
urlpatterns = [
    ...
    url(
        r"^administrative/(?P<string>[-\w]+)/$",
        views.administrativeView,
        name="administrative_view",
    ),
    ...
    url(
        r"^question_id_/(?P<id>[0-9]+)/$",
        views.ParticularQuestion,
    ...
    url(
        r"^downvote_answer/(?P<id>[0-9]+)$", views.downvoteAnswer, name="upvote_answer"
    ),
