...
class AskaQuestion(models.Model):
    ...
    def __str__(self):
        return f"{self.user} added ----> {self.subject} in {self.select_tag}"
...
class AnsweraQuestion(models.Model):
    ...
    def __str__(self):
        return f"{self.content} - answered the question - {self.question}"
...
class Reply(models.Model):
    ...
    def __str__(self):
        return f"{self.user} - replied on  - {self.comment} at {self.replied_at}"
...
class hidden(models.Model):
    ...
    def __str__(self):
        return f"{self.user} - hide - {self.question}"
