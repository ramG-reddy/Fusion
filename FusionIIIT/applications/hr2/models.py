...
class LTCform(models.Model):
    ...
    detailsOfFamilyMembersAboutToAvail = models.JSONField(
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="LTC_created_by"
    )
    approved_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="LTC_approved_by"
    )
...
class CPDAAdvanceform(models.Model):
    ...
    advanceDueAdjustment = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True
    )

    submissionDate = models.DateField(blank=True, null=True)

    balanceAvailable = models.DecimalField(
        max_digits=10, decimal_places=2, blank=True, null=True
    )
    advanceAmountPDA = models.DecimalField(
        max_digits=10, decimal_places=2, blank=True, null=True
    )
    amountCheckedInPDA = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True
    )
    ...
    approvedDate = models.DateField(auto_now_add=True, null=True)
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="CPDA_created_by"
    )
    approved_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="CPDA_approved_by"
    )
...
class LeaveForm(models.Model):
    ...
    approved_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="Leave_approved_by"
    )
...
class Appraisalform(models.Model):
    ...
    approvedDate = models.DateField(auto_now_add=True, null=True)
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="Appraisal_created_by"
    )
    approved_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="Appraisal_approved_by"
    )
...
class CPDAReimbursementform(models.Model):
    ...
    adjustmentSubmitted = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True
    )
    balanceAvailable = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True
    ...
    approvedDate = models.DateField(auto_now_add=True, null=True)
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="CPDAR_created_by"
    )
    approved_by = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="CPDAR_approved_by"
    )
