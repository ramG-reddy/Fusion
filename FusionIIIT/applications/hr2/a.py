def reverse_ltc_pre_processing(data):
    ...
    reversed_data["details_of_family_members_already_done"] = data[
...
data = {
    "block_year": "232",
    "pf_no": "4324",
    "basic_pay_salary": "324",
    "name": "sdf",
    "designation": "fds",
    "department_info": "dfs",
    "leave_availability": "True",
    "leave_start_date": "2024-03-13",
    "leave_end_date": "2024-03-17",
    "date_of_leave_for_family": "2024-03-16",
    "nature_of_leave": "erds",
    "purpose_of_leave": "fds",
    "hometown_or_not": "True",
    "place_of_visit": "fds",
    "address_during_leave": "dfsfsdf",
    "details_of_family_members_already_done": "fds,dfs,dfs",
    "family_members_about_to_avail": "1,dfsf,21,2,dsf,23,3,dfs,12",
    "details_of_dependents": "1,ds,12,2,sds,2,3,ds,13,None,None,None,None,None,None,None,None,None",
    "amount_of_advance_required": "1221",
    "certified_family_dependents": "213",
    "certified_advance": "213",
    "adjusted_month": "213",
    "date": "2024-03-15",
...

{
    ...
    "department_info": "dfs",
    "leave_availability": True,
    "leave_start_date": datetime.date(2024, 3, 13),
    "leave_end_date": datetime.date(2024, 3, 17),
    "date_of_leave_for_family": datetime.date(2024, 3, 16),
    "nature_of_leave": "erds",
    "purpose_of_leave": "fds",
    "hometown_or_not": True,
    "place_of_visit": "fds",
