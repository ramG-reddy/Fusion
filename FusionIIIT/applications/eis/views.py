            ...
            for row in reader:
                ...
                try:
                    if row["date_acceptance"] == " " or row["date_acceptance"] == "":
                        a = 1
                    elif row["date_acceptance"] != "0000-00-00 00:00:00":
                ...
                try:
                    if row["date_publication"] == " " or row["date_publication"] == "":
                        a = 1
                    elif row["date_publication"] != "0000-00-00 00:00:00":
            ...
            for row in reader:
                ...
                try:
                    if (
                        ...
                        a = 1
                    elif row["date_submission"] != "0000-00-00 00:00:00":
                        e.date_submission = row["date_submission"]
                        e.date_submission = datetime.datetime.strptime(
                            e.date_submission, "%Y-%m-%d"
                        ).date()
        ...
        if form.is_valid():
            ...
            for row in reader:
                ...
                try:
                    if row["date_entry"] == " " or row["date_entry"] == "":
                        a = 1
                    elif row["start_date"] != "0000-00-00 00:00:00":
                        e.date_entry = row["date_entry"]
                        e.date_entry = e.date_entry[:10]
                        e.date_entry = datetime.datetime.strptime(
                            e.date_entry, "%Y-%m-%d"
