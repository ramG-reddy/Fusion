...
class emp_visits(models.Model):
    ...
    def __str__(self):
        return f"PF No.: {self.pf_no}   Name: {self.country}   Purpose: {self.purpose}"
...
class emp_session_chair(models.Model):
    ...
    def __str__(self):
        return f"PF No.: {self.pf_no}   Name: {self.name}"
...
class emp_research_papers(models.Model):
    ...
    def __str__(self):
        return (
            f"PF No.: {self.pf_no}   Author: {self.authors}  Title: {self.title_paper}"
        )
...
class emp_published_books(models.Model):
    ...
    def __str__(self):
        return f"PF No.: {self.pf_no}   Type: {self.p_type}  Title: {self.title}"
...
class emp_patents(models.Model):
    ...
    def __str__(self):
        return f"PF No.: {self.pf_no}   Status: {self.status}  Title: {self.title}"
...
class emp_mtechphd_thesis(models.Model):
    ...
    def __str__(self):
        return f"PF No.: {self.pf_no}   Supervisor: {self.supervisors}  Title: {self.title}"
...
class emp_keynote_address(models.Model):
    ...
    def __str__(self):
        return f"PF No.: {self.pf_no}   Name: {self.name}  Title: {self.title}"
...
class emp_expert_lectures(models.Model):
    ...
    def __str__(self):
        return f"PF No.: {self.pf_no}  Title: {self.title}"
...
class emp_achievement(models.Model):
    ...
    def __str__(self):
        return f"PF No.: {self.pf_no} {self.a_type} : {self.details}"
