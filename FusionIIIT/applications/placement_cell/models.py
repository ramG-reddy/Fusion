...
class Project(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.project_name}"
...
class Has(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.skill_id.skill}"
...
class Experience(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.company}"
...
class Course(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.course_name}"
...
class Conference(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.conference_name}"
...
class Publication(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.publication_title}"
...
class Reference(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.reference_name}"
...
class Coauthor(models.Model):
    ...
    def __str__(self):
        return f"{self.publication_id.publication_title} - {self.coauthor_name}"
...
class Patent(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.patent_name}"
...
class Coinventor(models.Model):
    ...
    def __str__(self):
        return f"{self.patent_id.patent_name} - {self.coinventor_name}"
...
class Interest(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.interest}"
...
class Achievement(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.achievement}"
...
class Extracurricular(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.event_name}"
...
class NotifyStudent(models.Model):
    ...
    def __str__(self):
        return f"{self.company_name} - {self.placement_type}"
...
class PlacementStatus(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.notify_id.company_name}"
...
class StudentRecord(models.Model):
    ...
    def __str__(self):
        return f"{self.unique_id.id} - {self.record_id.name}"
...
class PlacementSchedule(models.Model):
    ...
    def __str__(self):
        return f"{self.notify_id.company_name} - {self.placement_date}"
