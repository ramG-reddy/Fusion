...
class projects(models.Model):
    ...
    project_investigator_id = models.ForeignKey(
        User, related_name="pi_id", on_delete=models.CASCADE
    )
    # rspc_admin_id=models.CharField(max_length=500)
    co_project_investigator_id = models.ForeignKey(
        User, related_name="copi_id", on_delete=models.CASCADE, null=True
    )
...
class requests(models.Model):
    ...
    project_investigator_id = models.ForeignKey(
        User, related_name="rj_pi", on_delete=models.CASCADE
    )
