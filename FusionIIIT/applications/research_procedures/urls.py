...
urlpatterns = [
    ...
    path(
        "add_financial_outlay/<pid>/",
        views.add_financial_outlay,
        name="add_financial_outlay",
    ),
    path(
        "financial_outlay/<pid>/",
        views.financial_outlay_form,
        name="financial_outlay_form",
    ),
    path(
        "view_financial_outlay/<pid>/",
        views.view_financial_outlay,
        name="view_financial_outlay",
    ),
    path("add_staff_details/<pid>/", views.add_staff_details, name="add_staff_details"),
    path(
        "view_staff_details/<pid>/", views.view_staff_details, name="view_staff_details"
    ),
    ...
    path(
        "update_financial_outlay/<pid>/",
        views.update_financial_outlay,
        name="update_financial_outlay",
    ),
    path("approve_request/<id>/", views.approve_request, name="approve_request"),
    path("view_file/<id>/", views.view_file, name="view_file"),
    path(
        "update_time_period/<id>/", views.update_time_period, name="update_time_period"
    ),
    path("change_year/<id>/", views.change_year, name="change_year"),
    path("change_end_date/<id>/", views.change_end_date, name="change_end_date"),
    path(
        "download_project_pdf/<int:project_id>/",
        views.download_project_pdf,
        name="download_project_pdf",
    ),
