...
urlpatterns = [
    ...
    path(
        "view_project_inventory/<pj_id>/",
        views.view_project_inventory,
        name="view_project_inventory",
    ),
    path(
        "view_project_staff/<pj_id>/",
        views.view_project_staff,
        name="view_project_staff",
    ),
