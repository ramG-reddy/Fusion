...
class All_Prescribed_medicine(models.Model):
    ...
    prescription_followup_id = models.ForeignKey(
        Prescription_followup, on_delete=models.CASCADE, null=True
    )
    quantity = models.IntegerField(default=0)
    ...
    revoked_prescription = models.ForeignKey(
        Prescription_followup,
        on_delete=models.CASCADE,
        null=True,
        related_name="revoked_priscription",
    )
