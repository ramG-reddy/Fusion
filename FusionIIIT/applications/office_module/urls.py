...
urlpatterns = [
    ...
    url(
        r"^officeOfPurchaseOfficer/",
        views.officeOfPurchaseOfficer,
    ...
    url(
        r"^officeOfRegistrar/response/ajax$",
        views.officeOfRegistrar_ajax_submit,
        name="officeOfRegistrar_ajax_submit",
    ),
    # url(r'^officeOfRegistrar/assistantRegistrar/$', views.assistantRegistrar, name="assistantRegistrar"),
    url(
        r"^officeOfRegistrar/forward/(?P<id>[0-9]+)",
        views.officeOfRegistrar_forward,
        name="officeOfRegistrar_forward",
    ),
    url(
        r"^officeOfRegistrar/forwardsubmit/$",
        views.officeOfRegistrar_forward_submit,
        name="officeOfRegistrar_forward_submit",
    ),
    ...
    url(
        r"^newordersdirectorview/",
        views.newordersdirectorview,
        name="newordersdirectorview",
    ),
    ...
    url(
        r"^newordersregistrar2/", views.newordersregistrar2, name="newordersregistrar2"
    ),
    ...
    url(
        r"^officeOfDeanRSPC/reallocate/$",
        views.project_reallocation,
        name="p_reallocation",
    ),
    url(
        r"^officeOfDeanRSPC/action/$",
        views.project_registration_permission,
        name="registration",
    ),
    url(
        r"^officeOfDeanRSPC/extension/$",
        views.project_extension_permission,
        name="extension",
    ),
    url(
        r"^officeOfDeanRSPC/closure/$", views.project_closure_permission, name="closure"
    ),
    url(
        r"^officeOfDeanRSPC/reallocation/$",
        views.project_reallocation_permission,
        name="reallocation",
    ),
    ...
    url(
        r"^officeOfDeanRSPC/registration_details/(?P<pr_id>[0-9]+)/$",
        views.reg_details,
        name="reg_details",
    ),
    url(
        r"^officeOfDeanRSPC/extension_details/(?P<pr_id>[0-9]+)/$",
        views.ext_details,
        name="ext_details",
    ),
    url(
        r"^officeOfDeanRSPC/closure_details/(?P<pr_id>[0-9]+)/$",
        views.closure_details,
        name="closure_details",
    ),
    url(
        r"^officeOfDeanRSPC/reallocation_details/(?P<pr_id>[0-9]+)/$",
        views.reallocate_details,
    ...
    url(
        r"^directorOffice/viewStaffProfile",
        views.viewStaffProfile,
        name="viewStaffProfile",
    ),
    url(
        r"^directorOffice/viewStudentProfile",
        views.viewStudentProfile,
        name="viewStudentProfile",
    ),
    url(
        r"^directorOffice/viewOngoingProjects",
        views.viewOngoingProjects,
        name="viewOngoingProjects",
    ),
    url(
        r"^directorOffice/viewOfficeBearers",
        views.viewOfficeBearers,
        name="viewOfficeBearers",
    ),
    url(
        r"^directorOffice/meeting_dropdown",
        views.meeting_dropdown,
        name="meeting_dropdown",
    ),
    ...
    url(
        r"^officeOfRegistrar/view/(?P<id>[0-9]+)",
        views.officeOfRegistrar_view_file,
        name="registrar_view_file",
    ),
    url(r"^officeOfRegistrar/upload/$", views.upload, name="upload"),
    url(
        r"^officeOfRegistrar/generalAdminForm/reject/$",
        csrf_exempt(views.admin_reject),
        name="admin_reject",
    ),
    url(
        r"^officeOfDeanStudents/$",
        views.officeOfDeanStudents,
        name="officeOfDeanStudents",
    ),
    url(
        r"^officeOfPurchaseOfficer/",
        views.officeOfPurchaseOfficr,
        name="officeOfPurchaseOfficer",
    ),
    url(r"^officeOfRegistrar/", views.officeOfRegistrar, name="officeOfRegistrar"),
    url(r"^genericModule/", views.genericModule, name="genericModule"),
    url(
        r"^officeOfDeanStudents/holding_meeting",
        views.holdingMeeting,
        name="holdingMeetings",
    ),
    url(
        r"^officeOfDeanStudents/meeting_Minutes",
        views.meetingMinutes,
        name="meetingMinutes",
    ),
    url(
        r"^officeOfDeanStudents/hostelRoomAllotment",
        views.hostelRoomAllotment,
        name="hostelRoomAllotment",
    ),
    url(
        r"^officeOfDeanStudents/deleteHostelRoomAllotment",
        views.deleteHostelRoomAllotment,
        name="deleteHostelRoomAllotment",
    ),
    url(
        r"^officeOfDeanStudents/deleteAllHostelRoomAllotment",
        views.deleteAllHostelRoomAllotment,
    ),
    ...
    url(
        r"^officeOfDeanAcademics/$",
        views.officeOfDeanAcademics,
        name="officeOfDeanAcademics",
    ),
    url(
        r"^officeOfDeanAcademics/assistantship",
        views.assistantship,
        name="assistantship",
    ),
    url(r"^officeOfDeanAcademics/formsubmit", views.formsubmit, name="formsubmit"),
    url(
        r"^officeOfDeanAcademics/init_assistantship",
        views.init_assistantship,
        name="init_assistantship",
    ),
    url(r"^officeOfDeanAcademics/scholarshipform", views.scholarshipform),
    url(
        r"^officeOfDeanAcademics/applications", views.applications, name="applications"
    ),
