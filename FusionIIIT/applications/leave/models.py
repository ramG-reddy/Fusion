...
class LeavesCount(models.Model):
    ...
    def __str__(self):
        return f"{self.user.username} in {self.year} has {self.remaining_leaves} {self.leave_type}s"
...
class Leave(models.Model):
    ...
    def __str__(self):
        return f"{self.applicant.username} applied, status: {self.status}"
...
class LeaveRequest(models.Model):
    ...
    def __str__(self):
        return f"{self.leave.applicant.username} requested {self.requested_from.username}, {self.permission}"
...
class LeaveMigration(models.Model):
    ...
    def __str__(self):
        return f"{self.replacee.username} : {self.replacer.username}, type => {self.type_migration}"
