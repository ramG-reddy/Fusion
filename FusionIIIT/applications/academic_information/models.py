...
class Curriculum(models.Model):
    ...
    def __str__(self):
        return f"{self.course_code} - {self.course_id.course_name}"
...
class Curriculum_Instructor(models.Model):
    ...
    def __self__(self):
        return f"{self.curriculum_id} - {self.instructor_id}"

    def __str__(self):
        return f"{self.curriculum_id.course_code} - {self.instructor_id.user.username}"
