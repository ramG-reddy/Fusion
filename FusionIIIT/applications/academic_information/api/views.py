...
def curriculum_api(request):
    if request.method == "GET":
        ...
        curriculum_serialized = serializers.CurriculumSerializer(
            curriculum, many=True
        ).data
        resp = {
...
def timetable_api(request):
    if request.method == "GET":
        ...
        timetable_serialized = serializers.TimetableSerializers(
            timetable, many=True
        ).data
        resp = {
...
def exam_timetable_api(request):
    if request.method == "GET":
        ...
        exam_timetable_serialized = serializers.Exam_timetableSerializers(
            exam_timetable, many=True
        ).data
        resp = {
...
def curriculum_instructor_api(request):
    if request.method == "GET":
        ...
        curriculum_instructor_serialized = serializers.CurriculumInstructorSerializer(
            curriculum_instructor, many=True
        ).data
        resp = {
...
def student_attendance_api(request):
    if request.method == "GET":
        ...
        student_attendance_serialized = serializers.Student_attendanceSerializers(
            student_attendance, many=True
        ).data
        resp = {
