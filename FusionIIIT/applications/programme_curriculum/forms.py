    ...
    class Meta:
        ...
        widgets = {
            ...
            "version": forms.NumberInput(
                attrs={
                    "placeholder": "Enter the latest version",
                    " class": "field",
                    "min": "1.0",
                },
            ),
...
class CourseProposalTrackingFile(ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            "file_id": forms.NumberInput(
                attrs={"placeholder": "Course Proposal id", "readonly": "readonly"},
            ),
            "current_id": forms.TextInput(
                attrs={
            ...
            "current_design": forms.TextInput(
                attrs={
                    "class": "ui fluid search selection dropdown",
                    "readonly": "readonly",
                },
            ),
            "receive_id": forms.Select(
                attrs={
                    "class": "ui fluid search selection dropdown",
                }
            ),
            "receive_design": forms.Select(
                attrs={
                    "class": "ui fluid search selection dropdown",
                }
            ),
            "disciplines": forms.Select(
                attrs={
                    "class": "ui fluid search selection dropdown",
                }
            ),
    ...
    def clean(self):
        ...
        data = HoldsDesignation.objects.select_related("designation").filter(
            user=r_id, designation=r_des
        )
