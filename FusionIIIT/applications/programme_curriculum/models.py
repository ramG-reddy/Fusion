...
class Curriculum(models.Model):
    ...
    version = models.DecimalField(
        ...
        validators=[
            ...
            DecimalValidator(max_digits=5, decimal_places=1),
        ],
    )
...
class Semester(models.Model):
    ...
    def __str__(self):
        return str(
            Curriculum.__str__(self.curriculum) + ", sem-" + str(self.semester_no)
        )
...
class NewProposalFile(models.Model):
    ...
    class Meta:
        unique_together = (
            ...
            "uploader",
            "name",
        )  # if code and faculty code matches to another proposal name will take care of it
...
class Proposal_Tracking(models.Model):
    ...
    receive_design = models.ForeignKey(
        Designation, blank=False, on_delete=models.CASCADE
    )
