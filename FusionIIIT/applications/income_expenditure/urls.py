...
urlpatterns = [
    ...
    url(
        r"^addExpenditureType/", views.add_expenditure_type, name="add-expenditure-type"
    ),
    ...
    url(
        r"^viewExpenditureStats/",
        views.view_expenditure_stats,
        name="view-expenditure-stats",
    ),
