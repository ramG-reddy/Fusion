...
from .models import authentication, hidden_grades
...
def submit(request):
    ...
    return render(
        request, "../templates/examination/submit.html", {"courses_info": courses_info}
    )
...
def verify(request):
    ...
    return render(
        request, "../templates/examination/verify.html", {"courses_info": courses_info}
    )
...
def authenticategrades(request):  # new
    ...
    if registrations:
        ...
        context = {"registrations": registrations, "year": year}
    else:
        course_instance = Courses.objects.get(id=course_id)
...
def announcement(request):
    ...
    try:
        ...
        return render(
            request,
            "examination/announcement_req.html",
            {
...
def generate_transcript_form(request):
    if request.method == "POST":
        ...
        context = {"students": students, "semester": semester}
...
class submitEntergradesStoring(APIView):
    ...
    def post(self, request):
        ...
        for student_id, batch_id, course_id, semester_id, year_id, mark, grade in zip(
            student_ids, batch_ids, course_ids, semester_ids, year_ids, marks, grades
        ):
            # Create an instance of hidden_grades model and save the data
        ...
        for student_id, batch_id, course_id, semester_id, year_id, mark, grade in zip(
            ...
            writer.writerow(
                [student_id, batch_id, course_id, semester_id, year_id, mark, grade]
            )
