...
class SectionIncharge(models.Model):
    ...
    work_type = models.CharField(
        choices=Constants.COMPLAINT_TYPE, max_length=20, default="Electricity"
    )
...
class Workers(models.Model):
    secincharge_id = models.ForeignKey(
        SectionIncharge, on_delete=models.CASCADE, null=True
    )
...
class Supervisor(models.Model):
    ...
    type = models.CharField(
        choices=Constants.COMPLAINT_TYPE, max_length=30, default="Electricity"
    )
