...
urlpatterns = [
    ...
    url(
        r"^appoint_student_counsellors/",
        views.appoint_student_counsellors,
        name="appoint_student_counsellors",
    ),
    url(r"^submitfaq/", views.submit_counselling_faq, name="submitfaq"),
    url(
        r"^assign_student_to_sg/",
        views.assign_student_to_sg,
        name="assign_student_to_sg",
    ),
